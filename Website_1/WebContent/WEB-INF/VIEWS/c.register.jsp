        ...
        <div class="col-md-12 ">
		   ...
		   <form action="/Website_1/register" method="post" modelAttribute="user">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="number" id="number" class="form-control" placeholder="10-digit phone number">
            </div>
            
            <div class="mb-3">
              <label for="address">Full Address</label>
              <input type="text" name="address" id="address" class="form-control" placeholder="Complete address">
            </div>
